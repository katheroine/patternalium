...
class SnippetConverting {
  ...
  public static void main(String[] args) {
    try {
      ...
      SnippetElementsExtractorCaretaker extractor = new SnippetElementsExtractorCaretaker(snippetInputFile);
      ArrayList<HTMLSnippetElement> snippetElements = extractor.extract();
