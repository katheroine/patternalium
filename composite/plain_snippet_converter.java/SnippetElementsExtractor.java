...
class SnippetElementsExtractor {
  ...
  private void constructElement(Node element) {
    switch (element.getNodeName()) {
      case "paragraph":
        HTMLSnippetElementComponent HTMLSnippetParagraphElement = new HTMLSnippetElementLeaf("p", refineText(element.getTextContent()));
        extractedElements.add(HTMLSnippetParagraphElement);

        break;
      case "list":
        String[] listRawItems = splitText(element.getTextContent());
        HTMLSnippetElementComponent HTMLSnippetListElement = new HTMLSnippetElementComposite("ul");
        ...
        for (String rawListItem : listRawItems) {
          ...
          HTMLSnippetElementComponent HTMLSnippetListItemElement = new HTMLSnippetElementLeaf("li", refinedListItem);
        ...
        break;
      case "source":
        HTMLSnippetElementComponent HTMLSnippetSourceElement = new HTMLSnippetElementLeaf("cite", refineText(element.getTextContent()));
