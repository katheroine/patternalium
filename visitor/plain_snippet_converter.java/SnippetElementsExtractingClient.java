...
class SnippetElementsExtractingClient {
  ...
  HTMLSnippetElementConvertingVisitor snippetElementConvertingVisitor;
  ...
  public SnippetElementsExtractingClient(File snippetFile) {
    ...
    snippetElementConvertingVisitor = new HTMLSnippetElementConvertingVisitor();
  }
  ...
  private void constructElement(Node element) {
    switch (element.getNodeName()) {
      case "paragraph":
        ...
        HTMLSnippetParagraphElement.accept(snippetElementConvertingVisitor);
      ...
      case "list":
        ...
        HTMLSnippetListElement.accept(snippetElementConvertingVisitor);

        break;
      case "source":
        HTMLSnippetPlainElement HTMLSnippetSourceElement = new HTMLSnippetPlainElement("cite", refineText(element.getTextContent()));
        HTMLSnippetSourceElement.accept(snippetElementConvertingVisitor);

        break;
    };

    extractedElements = snippetElementConvertingVisitor.getConvertedElements();
  }
