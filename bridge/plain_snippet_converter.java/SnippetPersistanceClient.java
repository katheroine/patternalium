...
class SnippetPersistanceClient {
  ...
  public void persist(ArrayList<SnippetElementAbstraction> snippetElements) throws IOException  {
      String fileContent = "";

      for (SnippetElementAbstraction snippetElement : snippetElements) {
