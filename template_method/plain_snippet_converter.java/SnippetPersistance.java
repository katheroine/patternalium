...
class SnippetPersistance {
  ...
  public void persist(ArrayList<HTMLSnippetElementAbstractClass> snippetElements) throws IOException  {
      String fileContent = "";

      for (HTMLSnippetElementAbstractClass snippetElement : snippetElements) {
        fileContent += snippetElement.getHTMLContentTemplateMethod();
      }
