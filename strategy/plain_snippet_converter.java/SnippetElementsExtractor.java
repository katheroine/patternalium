...
class SnippetElementsExtractor {
  ...
  private void constructElement(Node element) {
    HTMLSnippetElementContentCreatingStrategy contentCreatingStrategy;
    HTMLSnippetElementContext HTMLSnippetElement;

    switch (element.getNodeName()) {
      case "paragraph":
        String refinedParagraph = refineText(element.getTextContent());
        contentCreatingStrategy = new HTMLSnippetElementPlainContentCreatingStrategy();
        HTMLSnippetElement = new HTMLSnippetElementContext("p", refinedParagraph, contentCreatingStrategy);
      ...
      case "list":
        ...
        contentCreatingStrategy = new HTMLSnippetElementNestingContentCreatingStrategy();
        HTMLSnippetElement = new HTMLSnippetElementContext("ul", "li", listItemsContents, contentCreatingStrategy);
        extractedElements.add(HTMLSnippetElement);
      ...
      case "source":
        ...
        contentCreatingStrategy = new HTMLSnippetElementPlainContentCreatingStrategy();
        HTMLSnippetElement = new HTMLSnippetElementContext("cite", refinedSource, contentCreatingStrategy);
        extractedElements.add(HTMLSnippetElement);
